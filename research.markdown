...
<details>
  <summary style="display: flex; align-items: center;">
    ...
    <div style="background-color: #e4e4f7; margin-top: 10px; padding: 4px; border-radius: 8px; width:96%;">
        <center><img src="/assets/images/sysml_simulation.png" alt="Translating from SysML model to simulation language" style="width: 200px;"/></center>
        ...
        <center><img src="/assets/images/extended_sysml.png" alt="Extended SysML constructs in SysPhS" style="width: 200px;"/></center>
